...
E_Float* aa_vec       = tmp + (ithread-1)*size*20;
...
E_Float* yplusext_vec = aa_vec + size*16;
E_Float* nutext_vec   = aa_vec + size*17;
E_Float* gradNutext_vec  = aa_vec + size*18;
E_Float* conv_vec     = aa_vec + size*19;